...
// using Library.Infrastructure.Data; // Ensure this is the correct namespace for JsonData
// Update the using directive below to the correct namespace for JsonData:
// using Library.Data; // Replace with the actual namespace where JsonData is defined
// Update the using directive below to the correct namespace for JsonData:
using Library.Infrastructure.Data; // Ensure this matches the actual namespace for JsonData
...
public class ConsoleApp
{
    ...
    async Task<ConsoleState> PatronDetails()
    {
        ...
        {
            Console.WriteLine("No patron selected. Please select a patron first.");
            return ConsoleState.PatronSearchResults;
        }
    ...
    async Task<ConsoleState> SearchBooks()
    {
        ...
        // Check for an active loan (ReturnDate == null) for this BookItem
